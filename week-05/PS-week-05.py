...
location = 'LC08_L1TP_012030_20160830_20180130_01_T1_B10.tif'
def tif2array(location):
    # Load in band 1
    raster = os.path.join(DATA, location)
...
def rad_calc(tirs, var_list):
    ...
    rad
##do we have to Load in TIRS Band?
    """
...
## how to calculate ndvi_v?? why (0.5 - ndvi_s) ** 2??
